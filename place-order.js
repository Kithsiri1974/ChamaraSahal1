...
// Function called when the order is successfully saved
function handleOrderSaved(orderData) {
    // 1. Show your success message (as seen in your screenshot)
    alert(`Order Saved Successfully!\nReq No: ${orderData.reqNo}`);
    
    // 2. Automatically trigger the print dialog for the bill container
    printBillSection('bill-container');
}

function printBillSection(divId) {
    ...
    // 2. Write the bill contents and necessary styles into the iframe's document
    ...
    iframeDoc.write(`
        <html>
            <head>
                ...
                <style>
                    /* Include basic print styles or copy your bill styles here */
    ...
    // 3. Focus and trigger print, then clean up the iframe
    setTimeout(() => {
